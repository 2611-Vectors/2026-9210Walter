...
/** Creates a new AutoShooterDistance. */
    public RobotTarget(Drive m_Drive, Shooter m_Shooter, Intake m_Intake, FullSend m_FullSend, Transition m_Transition) {
        ...
        Supplier<Double> shooterSpeed =
                () -> TIP_TO_RPM * AutoMath.getFuelSpeedToRobot(RobotDist);

        addCommands(
                new ParallelCommandGroup(
                        m_Shooter.setShooterRPM(() -> shooterSpeed.get()),
                        m_FullSend.setFullSendRPM(() -> 5000.0),
                        m_Transition.setTransitionRPM(() -> 1000.0),
