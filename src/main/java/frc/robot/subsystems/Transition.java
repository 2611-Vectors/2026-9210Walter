...
public class Transition extends SubsystemBase {
    ...
    public Command setTransitionVoltage(Supplier<Double> lowerVoltage) {
        return run(() -> {
    ...
    public Command manualTransitionRPM(Supplier<Boolean> reverse) {
        ...
        // LoggedNetworkNumber upperRPM = new LoggedNetworkNumber("/Transition/Upper/Target RPM", 800.0);
